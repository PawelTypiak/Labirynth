...
void CBoki::loadTextureFromFile(char *filename) 
{ 
...
CBoki::CBoki(double dl,double sz, double x, double y, double z, double alfa, double beta, double gamma, float r, float g,float b)
{ 
	dlugosc=dl;
	szerokosc=sz;
